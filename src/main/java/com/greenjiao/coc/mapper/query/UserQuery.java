...
public class UserQuery {
    public static QueryWrapper<User> selectEntityQuery(User user) {
        ...
        wrapper.select("id", "account", "name", "gender", "telephone", "email", "signature", "avatar_address", "banned", "remark", "create_time")
    ...
    public static QueryWrapper<User> selectByIdQuery(String id, Boolean selectPwd) {
        ...
        QueryWrapper<User> wrapper = new QueryWrapper<>();
        ArrayList<String> fields = new ArrayList<>(Arrays.asList("id", "account", "name", "gender", "telephone", "email", "signature", "avatar_address", "banned", "remark", "create_time"));
        if (finalSelectPwd) {
            fields.add("password");
        }
